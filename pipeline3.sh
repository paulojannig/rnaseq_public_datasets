...
nohup ./scripts/02.fastqc.sh >> logs/log.02.fastqc.txt
nohup ./scripts/03.trimgalore.sh >> logs/log.03.trimgalore.txt
nohup ./scripts/07.kallisto.quant.sh >> logs/log.04.kallisto.quant.txt
