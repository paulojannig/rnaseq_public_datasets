...
mkdir -p ${PROJECT_FOLDER}/02_results/kallisto
...
cd ${PROJECT_FOLDER}/02_results/trimgalore
...
if [ $READ_TYPE = "PE" ]
then 
  KALLISTO_INPUT="${PROJECT_FOLDER}/02_results/trimgalore/${FILE}${SUFFIX1} ${PROJECT_FOLDER}/02_results/trimgalore/${FILE}${SUFFIX2}"
else
  KALLISTO_INPUT="${PROJECT_FOLDER}/02_results/trimgalore/${FILE}${SUFFIX1}"
fi

kallisto quant \
    -t ${THREADN} \
    -i ${KALLISTO_INDEX} \
    -o ${PROJECT_FOLDER}/02_results/kallisto/${FILE} \
    ${KALLISTO_INPUT}
done
...
kallisto version >> ${PROJECT_FOLDER}/00_reports/software_versions.txt
echo " ========================================================================================== "
printf "\n"
echo "Done!" `date`